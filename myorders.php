		...
		<div class="wrap cf">
            ...
            <div class="cart">
                ...
                if (isset($_SESSION["uid"])) {
                    $sql="SELECT c.order_id, a.product_id, a.product_title, a.product_price, a.product_image, b.qty, b.amt, c.total_amt, c.voucher_dis 
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            if ($prev_old == 0 || $prev_old == $order_id) {
                                ...
                                echo '</ul></div>
                                      ...
                                      <div class="subtotal cf">
                                          <ul>
                                              <li class="totalRow"><span class="label">Voucher Discount</span><span class="value">RM '.$voucher_dis.'</span></li>
                                              <li class="totalRow"><span class="label">Subtotal</span><span class="value">RM '.$prev_total.'</span></li>
                                              <li class="totalRow final"><span class="label">Total</span><span class="value">RM'.$prev_total.'</span></li>
                                          </ul>
                                      </div>
                            ...
                            if ($i == $numRows + 1) {
                                echo '<div class="special"><div class="specialContent">
                                          Thanks for Using our Platform
                                      </div></div>
                                      <div class="subtotal cf">
                                          <ul>
