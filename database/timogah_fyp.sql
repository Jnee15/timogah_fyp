...
CREATE TABLE `products` (
  ...
  `product_stores` int(100) NOT NULL,
...
INSERT INTO `products` (`product_id`, `product_cat`, `product_stores`, `product_title`, `product_price`, `product_desc`, `product_image`, `product_keywords`) VALUES
(1, 1, 1, 'Samsung galaxy s7 edge', 5000, 'Samsung galaxy s7 edge', 'product07.png', 'samsung mobile electronics'),
(2, 2, 2, 'Kids blue dress', 300, 'blue dress', '1543993724_pg4.jpg', 'kids blue dress');
...
(1, 'lee', 'minmin', 'leeminmin@gmail.com', 'minmin123', '0123456789', 'Samarahan', 'Sarawak');
